...
from constants import RANDOM_SEED, BERT_PRETRAINED_MODEL, NUM_CPU, \
    ARGUMENT_TOPICS_PRETRAIN_DATA_DIR, ARGUMENT_TOPICS_PRETRAIN_MLM_DIR, ARGUMENT_DOMAINS
...
logger = init_logger("MLM-pretraining", f"{ARGUMENT_TOPICS_PRETRAIN_MLM_DIR}")
...
def main():
    ...
    args.output_dir = Path(ARGUMENT_TOPICS_PRETRAIN_MLM_DIR) / args.domain / "model"
    args.fp16 = FP16
